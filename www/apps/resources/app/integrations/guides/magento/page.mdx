...
export const prepareHighlights = [
  ...
  ["90", "existingVariant", "Find the existing variant in the existing product, if set."],
  ["96", "prices", "Set the variant's prices based on the Magento child's price for every supported currency in the Medusa store."],
  ["105", "id", "Set the ID of the existing variant, if available."],
  ["109", "images", "Map the Magento product's media gallery entries to Medusa product images."],
  ["119", "set", "Add to the products to update."],
  ["121", "set", "Add to the products to create."],
]
